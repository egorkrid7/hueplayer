...
def _query(message):
    ...
    #     counter += 1
    bot.send_audio(message.from_user.id, caption="Егор Крид", audio="http://mjcdn.cc/2/310716274/0JXQs9C+0YAg0JrRgNC40LQgJiBNT0xMWSAtINCV0YHQu9C4INGC0Ysg0LzQtdC90Y8g0L3QtSDQu9GO0LHQuNGI0YwubXAz/")
